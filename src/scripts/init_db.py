...
columns = (["Difficulty","Scaled_Latitude","Scaled_Longitude",
            "Open January","Open February", "Open March","Open April",
            "Open May", "Open June", "Open July", "Open August",
            "Open September", "Open October", "Open November", "Open December"])
